<template>
  ...
  >
    <div>
      ...
      <!-- TODO: 搜索按钮(通用组件) -->
      <m-button
        class="opacity-0 absolute translate-y-[-50%] top-[50%] right-1 w-2 h-2 rounded-full duration-500 group-hover:opacity-100"
        icon="search"
        iconColor="#ffffff"
...
const containerTarget = ref(false)
